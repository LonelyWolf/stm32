...
#if (USART_USE_PRINTF)
// What USART_printf() should return
//   0 - always zero (less code, faster)
//   1 - number of transmitted characters (slower, but similar to printf())
#define USART_PRINTF_COUNTER       1
#endif
...
typedef struct {
	...
	uint32_t                       AF;       // USART alternate function mapping
