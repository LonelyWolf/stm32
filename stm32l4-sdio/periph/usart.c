...
void USART_ConfigureDMA(const USART_HandleTypeDef *USARTx, uint32_t DMA_DIR, uint32_t DMA_MODE, uint8_t *pBuf, uint32_t length) {
	if (DMA_DIR & USART_DMA_RX) {
		...
		//   IRQ: disabled
		//   channel: disabled
		USARTx->DMA_RX.Channel->CCR  = DMA_DIR_P2M | DMA_MALIGN_8BIT | DMA_PALIGN_32BIT | DMA_CCR_MINC | DMA_PRIORITY_MEDIUM | DMA_MODE;
	...
	if (DMA_DIR & USART_DMA_TX) {
		...
		//   IRQ: disabled
		//   channel: disabled
		USARTx->DMA_TX.Channel->CCR  = DMA_DIR_M2P | DMA_MALIGN_8BIT | DMA_PALIGN_32BIT | DMA_CCR_MINC | DMA_PRIORITY_MEDIUM | DMA_MODE;
