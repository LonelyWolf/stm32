...
//   pin - one of GPIO_Pin_X values
#define GPIO_PIN_SET(PORT,pin)     ((PORT)->BSRR = (uint32_t)pin)

// Port bit reset macros
// input:
//   PORT - one of GPIOx values
//   pin - one of GPIO_Pin_X values
#define GPIO_PIN_RESET(PORT,pin)   ((PORT)->BSRR = (uint32_t)pin << 16)
