...
#define SPI_BR_2           ((uint32_t)0x0000) // 2
#define SPI_BR_4           ((uint32_t)0x0008) // 4
#define SPI_BR_8           ((uint32_t)0x0010) // 8
#define SPI_BR_16          ((uint32_t)0x0018) // 16
#define SPI_BR_32          ((uint32_t)0x0020) // 32
#define SPI_BR_64          ((uint32_t)0x0028) // 64
#define SPI_BR_128         ((uint32_t)0x0030) // 128
#define SPI_BR_256         ((uint32_t)0x0038) // 256
...
#define SPI_CLK_PL_E1      ((uint32_t)0x00000000)        // Steady LOW,  1st edge (CPOL=0 CPHA=0)
