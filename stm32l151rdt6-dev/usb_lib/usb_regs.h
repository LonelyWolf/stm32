...
// Endpoint Addresses (with direction)
...
// Exported macros
#define _pEPTxAddr(bEpNum)  ((uint32_t *)(((USB->BTABLE + (bEpNum << 3))     << 1) + USB_PMAADDR))
#define _pEPTxCount(bEpNum) ((uint32_t *)(((USB->BTABLE + (bEpNum << 3) + 2) << 1) + USB_PMAADDR))
#define _pEPRxAddr(bEpNum)  ((uint32_t *)(((USB->BTABLE + (bEpNum << 3) + 4) << 1) + USB_PMAADDR))
#define _pEPRxCount(bEpNum) ((uint32_t *)(((USB->BTABLE + (bEpNum << 3) + 6) << 1) + USB_PMAADDR))
